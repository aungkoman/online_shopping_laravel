...
; (function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        lang: { // Language variables
            // cartTitle: "Shopping Cart", //default
            cartTitle: "Order List",
            checkout: 'Checkout',
            clear: 'Clear',
            subtotal: 'Subtotal:',
            cartRemove: '×',
            cartEmpty: 'Order List is Empty!<br />Choose your products'
        },
        submitSettings: {
    ...
    $.extend(SmartCart.prototype, {
        ...
        _setElements: function () {
            ...
            this.cart_element.append('<div class="panel-heading sc-cart-heading h3 border-bottom">' + this.options.lang.cartTitle + ' <span class="sc-cart-count badge">0</span></div>');
            this.cart_element.append('<div class="list-group mb-3"><textarea name="payment_address" class="p-2" placeholder="Enter Your Address"></textarea></div>');
            ...
            if (this.options.toolbarSettings.showCheckoutButton) {
                ...
                switch (this.options.toolbarSettings.checkoutButtonStyle) {
                    ...
                    case 'image':
                        ...
                        break;
                    default:
                        btnCheckout = '<button id="order-checkout"class="btn btn-info sc-cart-checkout " type="submit">' + this.options.lang.checkout + '</button> ';
                        break;
                }
