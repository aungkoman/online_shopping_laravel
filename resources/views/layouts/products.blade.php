    ...
    <div class="row g-0">
        ...
        <nav class="col-sm-12 col-md-12 col-lg-2  ">
            ...
            <div class="container  bg-light mt-1 mb-4  p-4 shadow-lg">
                ...
                <fieldset>
                    <form action="{{route('search',[ 'find' => 'price' ])}}" method="get">
                        @csrf
        ...
        <main class="col-sm-12 col-md-12 col-lg-8 ">
            ...
            <!-- all products -->
            <div class="container  bg-light mt-1 mb-4 p-4 shadow-lg">
                <h3 class="h3 text-start border-bottom">{{$title}}</h3>
                        ...
                        <div class="product-grid4">
                            <div class="product-image4">
                                ...
                                <ul class="social">
                                    ...
                                    <li class="to-wishlist" id="{{$product->id}}"><a href=" {{route('product.detail',$product)}}" data-tip="Add to Wishlist"><i class="fa fa-shopping-bag"></i></a></li>
                                    <li class="to-cart" id="{{$product->id}}"><a href=" {{route('product.detail',$product)}}" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
                                </ul>
